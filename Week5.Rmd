...
We would like to study the way the estimates for $\alpha$ and $\beta$ vary from sample to sample. For that purpose we will generate $R = 2000$ samples from the population described by the equation above. The we will estimate the regression model for each of these 2000 samples. What follows is a lot of rather technical details that
