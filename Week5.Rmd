...
## Warning: to compile the notes you need the bookdown and broom packages. Install them by
## running install.packages("bookdown") and install.packages("broom"), see the commented
## lines below
