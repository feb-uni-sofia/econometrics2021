...
## na.rm means to remove any missing values
mean_weight <- mean(earnings$weight_kg, na.rm = TRUE)
mean_height <- mean(earnings$height_cm)

## NA: missing/undefined value

ggplot(data = earnings, mapping = aes(x = weight_kg, y = height_cm)) +
  geom_point(position = "jitter", alpha = 0.3) +
  geom_hline(yintercept = 169) + ## average height
