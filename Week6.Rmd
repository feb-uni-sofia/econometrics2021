...
$$
\underbrace{C_i}_{Crime} = -50.8 + 1.48 \underbrace{\text{HS}_i}_{\text{Share of persons with high school degree}}
$$
Interpretation: comparing two counties: that differ by 1 percentage point on HS we expect the county with the higher HS to have 1.48 crimes
more for 100,000 inhabitants.
